    ...
    <ul class="navbar-nav ms-auto ms-md-0">
        <li class="nav-item dropdown user-dropdown">
            <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->nama_lengkap ?? 'W') }}&background=0d6efd&color=fff" alt="Avatar">
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                <li><a class="dropdown-item" href="{{ route('wali_kelas.profile') }}"><i class="fa-solid fa-user me-2"></i>Profil Saya</a></li>
