        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-body text-center">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->nama_lengkap ?? 'User') }}&size=150&background=0d6efd&color=fff" 
                         alt="Avatar" 
                         class="rounded-circle mb-3"
                         style="width: 150px; height: 150px;">
                    <h4 class="mb-1">{{ $user->nama_lengkap }}</h4>
                    <p class="text-muted mb-3">
                        <span class="badge bg-primary">{{ strtoupper($user->level) }}</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-4">
                            <strong><i class="fa-solid fa-briefcase me-2"></i>Spesialisasi</strong>
                        </div>
                        <div class="col-sm-8">
                            {{ $user->spesialisasi }}
                        </div>
