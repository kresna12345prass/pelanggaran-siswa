...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kesiswaan.prestasi.update', $prestasi) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tahun_ajaran_id" class="form-select @error('tahun_ajaran_id') is-invalid @enderror" required>
                                ...
                                @foreach($tahunAjaran as $ta)
                                    <option value="{{ $ta->id }}" {{ old('tahun_ajaran_id', $prestasi->tahun_ajaran_id) == $ta->id ? 'selected' : '' }}>
                                        {{ $ta->tahun_ajaran }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $prestasi->tanggal ? \Carbon\Carbon::parse($prestasi->tanggal)->format('Y-m-d') : '') }}" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="penghargaan" class="form-control @error('penghargaan') is-invalid @enderror" value="{{ old('penghargaan', $prestasi->penghargaan) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($prestasi->bukti_dokumen)
                                <small class="text-muted">File saat ini: <a href="{{ asset('storage/' . $prestasi->bukti_dokumen) }}" target="_blank">Lihat</a></small>
                            @endif
                ...
                <div class="mb-3">
                    ...
                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="3">{{ old('keterangan', $prestasi->keterangan) }}</textarea>
