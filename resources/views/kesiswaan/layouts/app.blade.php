...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/kesiswaan/layout.css'])
    @stack('styles')
</head>
<body>
    <div class="wrapper">
        ...
        <div class="main-content">
            @include('kesiswaan.partials.navbar')
            <main class="page-content">
                @yield('content')
            </main>
            @include('kesiswaan.partials.footer')
        </div>
    </div>
    <div class="sidebar-overlay"></div>
    @vite(['resources/js/app.js', 'resources/js/kesiswaan/layout.js'])
    @stack('scripts')
</body>
</html>
